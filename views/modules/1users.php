        ...
        <div class="box-body">
          ...
          <div class="form-group">
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="newUser" placeholder="Add username" required autocomplete="username">
              </div>
          </div>
          ...
          <div class="form-group">
              <div class="input-group">
                ...
                <input type="password" class="form-control input-lg" name="newPasswd" placeholder="Input password" required autocomplete="current-password">
              </div>
          </div>
